...
// Which spot the chart's arrows belong to. Seeded on load to whichever spot is
// best at that moment, and thereafter it only changes when you pick one.
//
// Making the arrows FOLLOW the recommendation as the time bar moved was tried
// and taken out: the arrows jumped from beach to beach mid-scrub, which reads
// as the map twitching rather than as an answer. The bar is for watching one
// spot through time; where to go is the verdict card's job and the X's.
