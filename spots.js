...
const SPOTS = [
  {
    ...
    swell_window: [50, 140], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, exposure: 0.75, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [50, 140], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, exposure: 0.85, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [55, 145], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, exposure: 0.9, tide_pref: null,
