...
//   55%/80% of good_size_m; meant to be tuned by hand as the rubric is calibrated.
...
const SPOTS = [
  {
    ...
    swell_window: [20, 90], min_period_s: 0, good_size_m: [0.3, 1.5], size_ref_m: { head_high: 1.0, overhead: 1.3 }, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [25, 100], min_period_s: 9, good_size_m: [0.5, 2], size_ref_m: { head_high: 1.3, overhead: 1.7 }, tide_pref: "mid-high",
  ...
  },
  {
    ...
    swell_window: [50, 140], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [55, 145], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [70, 150], min_period_s: 11, good_size_m: [1, 3], size_ref_m: { head_high: 2.1, overhead: 2.6 }, tide_pref: "mid-high",
  ...
  },
  {
    ...
    swell_window: [60, 150], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [65, 155], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [70, 160], min_period_s: 0, good_size_m: [0.5, 2.5], size_ref_m: { head_high: 1.6, overhead: 2.1 }, tide_pref: null,
  ...
  },
  {
    ...
    swell_window: [90, 170], min_period_s: 10, good_size_m: [1, 3], size_ref_m: { head_high: 2.1, overhead: 2.6 }, tide_pref: "mid-high",
